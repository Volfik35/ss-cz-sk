...
",
'subject__post_was_quoted'				=> "<a href='%s'>%s</a> <a href='%s'>citoval</a> <a href='%s'>tvůj příspěvek</a>",
...
'subject__personal_convo_new_reply'				=> "<a href='%s'>%s</a> odpověděl na status, <a href='%s'>.</a>",
...
'subject__other_status_reply'				=> "<a href='%s'>%s</a> odpověděl na <a href='%s'>%s</a> <a href='%s'>status</a>",
'subject__status_reply'				=> "<a href='%s'>%s</a> odpověděl na tvůj <a href='%s'>status</a>",
